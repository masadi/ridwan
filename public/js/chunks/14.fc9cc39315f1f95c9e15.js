...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    ...
    BCardSubTitle: bootstrap_vue__WEBPACK_IMPORTED_MODULE_7__["BCardSubTitle"],
  ...
  data: function data() {
    return {
      ...
      //app: $themeConfig.app,
      app: _store_index__WEBPACK_IMPORTED_MODULE_11__["default"].state.appConfig.app
    };
  },
  computed: {
              ...
              _this.$router.replace(replace).then(function () {
                _this.$toast({
                  ...
                  props: {
                    ...
                    icon: 'CoffeeIcon',
                    variant: 'success',
                    text: "Anda telah berhasil masuk sebagai ".concat(userData.user.role, ". Sekarang Anda dapat mulai berselancar di Aplikasi ").concat(_this.app.name, "!")
                  }
                });
              });
            } else {
